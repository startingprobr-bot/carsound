...
// Cache de AudioBuffers já decodificados
const bufferCache = new Map<string, AudioBuffer>();

export const SOUND_EFFECTS: SoundEffect[] = [
  { id: 'aplausos', name: 'Aplausos', emoji: '👏', category: 'Público', url: '/effects/aplausos.mp3' },
  { id: 'aplausos-2', name: 'Aplausos 2', emoji: '👏', category: 'Público', url: '/effects/aplausos-2.mp3' },
  { id: 'cantada-pneu', name: 'Cantada de Pneu', emoji: '🏎️', category: 'Veículos', url: '/effects/cantaa-de-pneu.mp3' },
  { id: 'coracao', name: 'Coração', emoji: '❤️', category: 'Clássicos', url: '/effects/coracao.mp3' },
  { id: 'digitando', name: 'Digitando', emoji: '⌨️', category: 'Clássicos', url: '/effects/digitando.mp3' },
  { id: 'dinheiro', name: 'Dinheiro', emoji: '💰', category: 'Clássicos', url: '/effects/dinheiro.mp3' },
  { id: 'dinheiro-2', name: 'Dinheiro 2', emoji: '💰', category: 'Clássicos', url: '/effects/dinheiro-2.mp3' },
  { id: 'efeito-magico', name: 'Efeito Mágico', emoji: '✨', category: 'Impacto', url: '/effects/efeito-magico.mp3' },
  { id: 'fiuiiii', name: 'Fiuiiii', emoji: '🎵', category: 'Público', url: '/effects/fiuiiii.mp3' },
  { id: 'gliter', name: 'Glitter', emoji: '✨', category: 'Impacto', url: '/effects/gliter.mp3' },
  { id: 'oh-my-gosh', name: 'Oh my Gosh', emoji: '😮', category: 'Público', url: '/effects/oh-my-gosh.mp3' },
  { id: 'pinnnn', name: 'Pinnnn', emoji: '🔔', category: 'Notificação', url: '/effects/pinnnn.mp3' },
  { id: 'pop', name: 'Pop', emoji: '💥', category: 'Impacto', url: '/effects/pop.mp3' },
  { id: 'sensura', name: 'Censura', emoji: '🤬', category: 'Clássicos', url: '/effects/sensura.mp3' },
  { id: 'tic-tac', name: 'Tic Tac', emoji: '⏰', category: 'Clássicos', url: '/effects/tic-tac.mp3' },
...
/** Carrega e decodifica o AudioBuffer de um efeito (com cache) */
